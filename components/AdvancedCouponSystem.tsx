      ...
      {!appliedCoupon ? (
        <>
          <div>
            ...
            <div className="flex space-x-2">
              <input
                ...
                className="flex-1 px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-sm"
              />
              <button
                onClick={handleApply}
          ...
          <button
            ...
            className="text-sm text-emerald-700 hover:text-emerald-900 font-medium flex items-center whitespace-nowrap"
          >
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center space-x-2">
                        <span className="bg-emerald-100 text-emerald-800 px-3 py-1 rounded-lg font-bold text-sm">
                          {coupon.code}
                        </span>
                        {!isEligible && (
                      ...
                      {isEligible && (
                        <button
                          ...
                          className="text-emerald-700 hover:text-emerald-900 font-semibold text-sm whitespace-nowrap"
                        >
                          Apply
                        </button>
                      )}
          ...
          <div className="flex items-center justify-between">
            <div>
              <div className="flex items-center space-x-2 mb-1">
                <i className="ri-price-tag-3-fill text-emerald-700"></i>
                <span className="font-bold text-emerald-800">{appliedCoupon.code}</span>
              </div>
              <p className="text-sm text-emerald-700">{appliedCoupon.description}</p>
            </div>
            <button
              onClick={onRemove}
              className="w-8 h-8 flex items-center justify-center text-emerald-700 hover:text-emerald-900 transition-colors"
            >
