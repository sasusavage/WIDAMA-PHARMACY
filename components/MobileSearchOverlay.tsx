        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="flex-1 relative">
            <input
              ...
              className="w-full pl-10 pr-10 py-3 bg-gray-100 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500"
              autoFocus
            />
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <button 
                    ...
                    className="text-xs text-emerald-700 font-medium whitespace-nowrap"
                  >
                    Clear All
                  </button>
                </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {popularSearches.map((search, index) => (
                  <button
                    key={index}
                    className="px-4 py-2 bg-gray-100 text-gray-700 text-sm rounded-full hover:bg-emerald-50 hover:text-emerald-700 transition-colors whitespace-nowrap"
                  >
                    {search}
                  </button>
                ))}
